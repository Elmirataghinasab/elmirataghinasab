...
# 💫 About Me:
Blockchain Developer and Smart Contract Engineer with 4 years of hands-on experience building decentralized applications, writing and auditing Solidity contracts, and crafting high-performance frontends.

I bring a rare combination of on-chain and off-chain expertise — from architecting smart contracts and DeFi protocols to building the React/Next.js interfaces users actually interact with. I hold myself to a high standard: clean code, secure contracts, and polished UI are non-negotiable.

Open to full-time Web3 roles and freelance blockchain projects.
...
### Blockchain & Web3
- Solidity · Smart Contract Development · Smart Contract Auditing
- dApp Development · DeFi Protocols · Web3 Integration
...
- Developed and deployed smart contracts for client projects in the DeFi space
- Conducted smart contract security audits
- Built full-stack dApps combining Solidity backends with React/Next.js frontends
- Delivered frontend projects using modern JS frameworks and TailwindCSS
...
*Open to full-time Web3 roles and freelance blockchain projects. Feel free to explore my repositories *
